...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col md:flex-row overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <div className="max-w-md">
            <h2 className="text-5xl font-display font-bold text-white leading-tight mb-6">
              Gestão de documentos <span className="text-emerald-400">simplificada</span> para sua empresa.
            </h2>
      ...
      <div className="flex-1 flex items-center justify-center p-8 md:p-16 lg:p-24 bg-zinc-50">
        <motion.div 
        ...
        >
          <div className="mb-10">
            <h1 className="text-4xl font-display font-bold text-zinc-900 mb-2">Bem-vindo de volta</h1>
            <p className="text-zinc-500">Insira suas credenciais para acessar sua conta.</p>
          </div>
          ...
          <form onSubmit={handleLogin} className="space-y-6">
            ...
            <div className="space-y-2">
              <label className="text-sm font-semibold text-zinc-700 ml-1">Endereço de Email</label>
